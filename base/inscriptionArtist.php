...
<html lang = "fr">
    ...
    <body>
        ...
        <?php if (isset($_POST['submit']) && ($formError == null)) {
            ?>
            <p class="result">Nom : <?= $pseudo ?></p>
            <p class="result">Ville : <?= $town ?></p>
            <p class="result">Présentation : <?= $present ?></p>
            <!--Sinon affiche le formulaire-->
        <?php } else { ?>
            <div class="row">            <!--Sinon affiche le formulaire-->
                <form class="col s12" method="POST" action="myprofileArtist.php" >
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <label for="pseudo">Pseudo de connexion<?= isset($formError['pseudo']) ? $formError['pseudo'] : ''; ?></label>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea id="present" class="materialize-textarea" name="present" placeholder="renseignez sur votre parcours, votre travail" maxlength="2000" value="<?= isset($present) ? $present : '' ?>"></textarea>
