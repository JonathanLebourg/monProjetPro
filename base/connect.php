            ...
            <form>
                <div class="row">  
                    <div class="input-field col s6">  
                        ...
                        <label class="label" for="artistName">Pseudo de connexion</label>  
                    </div>
                    <div class="input-field col s6">  
                        <i class="material-icons prefix">lock_open</i>  
                        <input id="artistName" type="password" required />  
                        <label class="label" for="artistName">Mot de passe</label>  
                    </div>
                </div>
            </form>
        </div>
