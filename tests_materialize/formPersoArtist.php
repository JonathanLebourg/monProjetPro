...
<html>
    <head>
        ...
        <title>Forms Materialize php</title>
    </head>
    <body>
        ...
        <div class="container">
            <div class="container">
                ...
                <?php } else { ?>
                    <form class="col s12" method="post" action="formPersoArtist.php">  
                        <fieldset>
                            <legend>Création de votre compte</legend>                            
                            <div class="row">  
                                <div class="input-field col s6">  
                                    <i class="material-icons prefix">account_circle</i>  
                                    <input name="pseudo" placeholder="Picasso" id="pseudo" type="text" required />  
