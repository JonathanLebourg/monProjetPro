...
$pages = [
    ...
    'worksForm' => 'views/worksForm.php',
    'estimateForm' => 'views/estimateForm.php',
    'myprofileAdmin' => 'views/myprofileAdmin.php',
    'myprofileArtist' => 'views/myprofileArtist.php',
    'modifProfile' => 'views/modifProfile.php',
...
<!--        <link rel="stylesheet" href="owlcarousel/assets/owl.carousel.min.css">        
    ...
    <body>
            ...
            if (!isset($_GET['page'])) {
                ...
                switch ($_GET['page']) {
                    ...
                    case 'myprofileArtist':
                        ...
                        break;
                    case 'modifProfile':
                        include('views/modifProfile.php');
                        break;
        ...
        <!--pour l input ville , plugin vicopo-->
