...
Les conditions générales de vente entre professionnels (ou B2B) doivent obligatoirement mentionner :
                ...
                Les CGV peuvent aussi prévoir des mentions facultatives, mais importantes, portant sur les conditions de résiliation du contrat, sur l'existence d'une clause de réserve de propriété, etc.</p>
        </div>
        <div class="modal-footer">
            <a href="#!" class="modal-close waves-effect waves-green btn-flat">J'ai bien pris connaissance des conditions générales</a>
        </div>
    </div>
</footer>
